...
public class Baseclass {
	...
	public static ReadConfigProperties note = new ReadConfigProperties();
	...
	public static void reportSetup()
	{
		...
		reports.setSystemInfo("Project", "Revision");
		reports.setSystemInfo("Platfrom", "Windows 10");
		reports.setSystemInfo("Platfrom", "Laptop");
